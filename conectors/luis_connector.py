...
class LUISConnector(Connector):
    ...
    def __init__(self, model_file):
        ...
        self.url = ''
        # Takes either 'true' or 'false', depending on whether app is in staging or production
        self.staging = 'true'
    ...
    def get_app_url(self):
        ...
        :return: str
        """
        self.url = APPS_PAGE+'{}?verbose={}&timezoneOffset=-360&subscription-key={}&q='\
            .format(self.get_app_id(), self.get_verbose(), self.get_app_key())
        return self.url
